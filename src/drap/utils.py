...
class ImageCropper(QMainWindow):
    ...
    def initUI(self):
        ...
        # Group to third-a integer
        self.int_group3a = QGroupBox("Time initial")
        self.int_layout3a = QVBoxLayout()
        self.int_group3a.setLayout(self.int_layout3a)
        self.int_input_label3a = QLabel('Type the value of initial time (s):', self)
        self.int_input3a = QLineEdit(self)
        self.int_input3a.setText("0") 
        self.int_output3a = QLabel('', self)
        self.int_layout3a.addWidget(self.int_input_label3a)
        self.int_layout3a.addWidget(self.int_input3a)
        self.int_layout3a.addWidget(self.int_output3a)
        self.controls_layout.addWidget(self.int_group3a)
    ...
    def calcule_size_drop(self):
        ...
        if (self.int_input1.text() and self.int_input2.text() and self.int_input3.text() and self.int_input4.text()):
            numbers = [(input_field.text()) for input_field in [self.int_input1,self.int_input2, self.int_input3a, self.int_input3, self.int_input4]];
